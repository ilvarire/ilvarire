...
<div x-data="{ showProductModal: false, showSearchBox: false}" x-on:openProductModal.window="showProductModal = true"
    ...
    <!-- Slider -->
    <section class="section-slide" wire:ignore>
        <div class="wrap-slick1">
            <div class="slick1">
                @include('livewire.customer.includes.hero-slider')
            </div>
        </div>
    </section>

    <!-- Banner -->
    <div class="sec-banner bg0 p-t-80 p-b-50" wire:ignore>
        <div class="container">
            <div class="row">
                @include('livewire.customer.includes.banner')
            </div>
        </div>
    </div>
