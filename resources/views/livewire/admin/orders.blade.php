<div x-data="{ showModal: false}" x-on:open-order-modal.window="showModal = false"
    x-on:close-order-modal.window="showModal = false">
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
        @if (session()->has('success'))
            <a class="flex items-center justify-between p-4 mb-8 text-sm font-semibold text-purple-100 bg-purple-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple"
                ...
                <span>See products &RightArrow;</span>
            </a>
        @endif
            ...
            @if ($selectedOrder)
                ...
                <div class="mt-4 mb-6">
                    <div>
                        ...
                        <p class="mb-2 text-sm font-semibold text-gray-700 dark:text-gray-300">
                            Amount: <strong>${{ number_format($selectedOrder->total_price, 2) }}</strong>
                        </p>
                    ...
                    <span class="mb-2 text-xs self-center font-semibold text-gray-700 dark:text-gray-300">
                        Cart Items ({{count($selectedOrder->orderItems)}})
                    </span>

                    @foreach ($selectedOrder->orderItems as $item)
                        <!-- Modal description -->
                        <a href="{{ route('admin.products') }}?product_id={{$item->product->id}}">
                            <div class="flex px-4 py-3 mb-8 mt-2 bg-white rounded-lg shadow-md dark:bg-gray-800">
                                ...
                                <p class="text-xs text-gray-600 dark:text-gray-400">
                                    ...
                                    Quantity: {{$item->quantity}} = ${{ number_format($item->price)}}<br>
                                    Price: ${{ number_format($item->price)}} X {{$item->quantity}} =
                    ...
                    <div class="flex px-4 py-3 mb-8 mt-2 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <p class="text-xs text-gray-600 dark:text-gray-400">
                            ...
                            Fee per kg/Base fee:
                            ${{ $selectedOrder->shippingAddress->shippingFee->fee_per_kg }} /
                            ${{ $selectedOrder->shippingAddress->shippingFee->base_fee }}<br>
                    ...
                    <footer
                        ...
                        @if($selectedOrder->status === 'processed')
                            <button @click="showModal = false" wire:click="shipOrder('{{ $selectedOrder->id }}')"
                        ...
                        @elseif($selectedOrder->status === 'shipped')
                            <button @click="showModal = false" wire:click="deliverOrder('{{ $selectedOrder->id }}')"
                                class=" w-full px-5 py-3 text-sm font-medium leading-5 text-white transition-colors
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                duration-150 bg-purple-600 border border-transparent rounded-lg sm:w-auto sm:px-4 sm:py-2
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                                Deliver
