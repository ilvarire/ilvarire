    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
        @if (session()->has('success'))
            <a class="flex items-center justify-between p-4 mb-8 text-sm font-semibold text-purple-100 bg-purple-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple"
                ...
                <span>See Customers &RightArrow;</span>
            </a>
        @endif
        <h2 class="mt-4 ml-4 text-xs font-semibold text-gray-700 dark:text-gray-200">
            Add Email
        </h2>
        <form wire:submit.prevent="storeEmail" method="POST" class="flex justify-around ml-4 mt-2 flex-1 lg:mr-32">
            @csrf
            <input type="email" wire:model.live="email"
                ...
                placeholder="Email" style="width: 175px" required />
                ...
                <template x-if="action === 'edit'">
                    <div>
                        ...
                        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                            <form method="POST" wire:submit.prevent="updateEmail" id="update_email">
                                @csrf
                        ...
                        <footer
                            ...
                            <button type="submit" form="update_email"
